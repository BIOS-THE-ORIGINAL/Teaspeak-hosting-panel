...
function PopUpCal() {
	...
	this.regional[''] = { // Default regional settings
		...
		prevText: '&lt;Onceki', // Display text for previous month link
		nextText: 'Sonraki&gt;', // Display text for next month link
		currentText: 'Bugun', // Display text for current month link
		dayNames: ['Pz','Pt','Sa','Cs','Pe','Cu','Ct'], // Names of days starting at Sunday
		monthNames: ['Ocak','Subat','Mart','Nisan','Mayis','Haziran',
			'Temmuz','Agustos','Eylul','Ekim','Kasim','Aralik'], // Names of months
