...
require 'baglantilar/framework/TeamSpeak3.php';
...
<head>
 ...
 <link rel="stylesheet" href="tasarim/tasarims.css">
  ...
  <form>
	...
	<div class="inputGroup inputGroup2">
		...
		<input type="password" id="password" name="password" placeholder="" required>
								...
								<BR><center><button class="btn btn-default block">Sign In</button></center>
...
<script src='tasarim/MorphSVGPlugin.min.js?r=182'></script>

<script src='tasarim/dosya.js'></script>  
